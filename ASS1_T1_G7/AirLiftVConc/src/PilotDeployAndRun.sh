...
sshpass -f password ssh sd107@l040101-ws06.ua.pt 'mkdir -p ~/pilot'
sshpass -f password ssh sd107@l040101-ws06.ua.pt 'rm -rf ~/pilot/*'
sshpass -f password scp pilot.zip sd107@l040101-ws06.ua.pt:~/pilot/
