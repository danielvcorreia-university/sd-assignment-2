...
sshpass -f password ssh sd107@l040101-ws03.ua.pt 'mkdir -p ~/destinationairport'
sshpass -f password ssh sd107@l040101-ws03.ua.pt 'rm -rf ~/destinationairport/*'
sshpass -f password scp destinationairport.zip sd107@l040101-ws03.ua.pt:~/destinationairport/
